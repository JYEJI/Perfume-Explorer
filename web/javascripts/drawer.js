...
var count = 0;
$('.slideshow-container').width = $(window).width()-240-576+500-50;
$('.slideshow-container').height = $(window).height();
$('.mySlides1').width = $(window).width()-240-576+500-50;
$('.mySlides1').height = $(window).height() / 8;
$('.mySlides1').css('margin-top', $(window).height() - $(window).height() / 3)
$(window).click(function (e) {
    if (count < 29) {
        ...
        d3.selectAll('.slideshow-container').remove();
        something();
    }
});
...
function VisStart(){
    ...
    root.attr('width', windowWidth-240-576+400).attr('height', (windowHeight+550)/2);
    ...
    var Vis = new function () {
        ...
        var parentG = root.append('g')
            .attr('transform', 'translate('+((windowWidth-240-576-50))+','+(windowHeight/2-56)+')');
        ...
        this.drawDimension = function (keys,name) {
            ...
            var g = root.append('g');
            g.attr('transform', 'translate('+((windowWidth-240-576-50))+','+(windowHeight/2-56)+')').attr('id',name);
            ...
            function mouse(e) {
                return [e.pageX-(windowWidth-240-576-50), e.pageY-windowHeight/2-56];
            }
            ...
            function mouseup() {
                if (m0) {
                    ...
                    g.attr('transform', 'translate('+((windowWidth-240-576-50))+','+(windowHeight/2-56)+')rotate(' + rotate + ')');
                    console.log("dm:"+dm);
            ...
            function setState(dm){
                g.attr('transform', 'translate('+((windowWidth-240-576-50))+','+(windowHeight/2-56)+')rotate(' + (rotate + dm) + ')');
            }
